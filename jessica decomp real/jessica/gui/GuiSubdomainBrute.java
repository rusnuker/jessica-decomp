...
public class GuiSubdomainBrute
extends JFrame {
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try {
                    ...
                    forkJoinPool.submit(() -> ((Stream)Arrays.stream(GuiSubdomainBrute.this.subs.toArray()).parallel()).forEach(sub -> GuiSubdomainBrute.this.go(String.valueOf(sub.toString()) + "." + GuiSubdomainBrute.this.jTextField2.getText())));
                }
