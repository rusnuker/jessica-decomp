...
implements IBlockAccess {
    ...
    protected void onEntityAdded(Entity entityIn) {
        ...
        try {
            EntityPlayer e;
            if (entityIn instanceof EntityPlayer && Wrapper.getModule("Killaura").isToggled() && !((e = (EntityPlayer)entityIn) instanceof EntityPlayerSP) && !e.isDead && !e.isInvisible() && Wrapper.player().getDistanceToEntity(e) >= 16.0f && !Killaura18.PlayerAuraAAC.contains(e)) {
                Killaura18.PlayerAuraAAC.add(e);
            }
        }
