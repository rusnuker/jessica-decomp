...
public class RenderManager {
    ...
    public void renderEntityStatic(Entity entityIn, float partialTicks, boolean p_188388_3_) {
        ...
        double d2 = entityIn.lastTickPosY + (entityIn.posY - entityIn.lastTickPosY) * (double)partialTicks;
        double d3 = entityIn.lastTickPosZ + (entityIn.posZ - entityIn.lastTickPosZ) * (double)partialTicks;
    ...
    public void doRenderEntity(Entity entityIn, double x, double y, double z, float yaw, float partialTicks, boolean p_188391_10_) {
        block10: {
            ...
            try {
                ...
                CrashReport crashreport = CrashReport.makeCrashReport(throwable5, "Rendering entity in world");
                ...
                crashreportcategory2.addCrashSection("Rotation", Float.valueOf(yaw));
    ...
    public void renderMultipass(Entity p_188389_1_, float p_188389_2_) {
        ...
        double d2 = p_188389_1_.lastTickPosY + (p_188389_1_.posY - p_188389_1_.lastTickPosY) * (double)p_188389_2_;
        double d3 = p_188389_1_.lastTickPosZ + (p_188389_1_.posZ - p_188389_1_.lastTickPosZ) * (double)p_188389_2_;
    ...
    private void renderDebugBoundingBox(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (aentity != null) {
            ...
            while (i < length) {
                ...
                double d2 = (entity.posY - entity.prevPosY) * (double)partialTicks;
                double d3 = (entity.posZ - entity.prevPosZ) * (double)partialTicks;
    ...
    public double getDistanceToCamera(double x, double y, double z) {
        ...
        double d2 = y - this.viewerPosY;
        double d3 = z - this.viewerPosZ;
