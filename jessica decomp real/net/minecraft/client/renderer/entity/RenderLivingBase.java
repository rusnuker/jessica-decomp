...
extends Render<T> {
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        boolean flag2 = this.wallhack(entitylivingbaseIn);
        if (flag || flag1 || flag2) {
            ...
            if (Wrapper.getModule("PlayerLine").isToggled() && entitylivingbaseIn instanceof EntityPlayer) {
                GL11.glPushMatrix();
                ...
                Wrapper.getFriends();
                if (FriendManager.isFriend(((Entity)entitylivingbaseIn).getName())) {
                    GL11.glColor3f((float)0.0f, (float)255.0f, (float)0.0f);
                } else if (entitylivingbaseIn instanceof EntityPlayerSP) {
                    GL11.glColor4f((float)1.0f, (float)0.0f, (float)2.0f, (float)0.8f);
                } else {
    ...
    protected boolean wallhack(T ent) {
        return ((Entity)ent).isInvisible();
    }
