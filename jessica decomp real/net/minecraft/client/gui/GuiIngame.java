...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Wrapper.onRender2D(eventRender2D);
        ...
        if (this.titlesTimer > 0) {
            ...
            if ((i2 = MathHelper.clamp(i2, 0, 255)) > 8) {
                ...
                if (this.displayedTitle.contains("\u0424\u0443\u043d\u043a\u0446\u0438\u044f ")) {
                    ...
                    this.getFontRenderer().drawString(this.displayedTitle, -this.getFontRenderer().getStringWidth(this.displayedTitle) / 2, -10.0f, 0xFFFFFF | j3, true);
                }
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0f, 2.0f, 2.0f);
                fontrenderer.drawString(this.displayedSubTitle, -fontrenderer.getStringWidth(this.displayedSubTitle) / 2, 5.0f, 0xFFFFFF | j3, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
